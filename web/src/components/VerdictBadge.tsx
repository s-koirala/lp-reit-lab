...
const STYLES: Record<Verdict, { label: string; cls: string; dot: string }> = {
  go: { label: "GO", cls: "text-go-strong border-go/40 bg-go/10", dot: "bg-go" },
  watch: { label: "WATCH", cls: "text-watch-strong border-watch/40 bg-watch/10", dot: "bg-watch" },
  "no-go": { label: "NO-GO", cls: "text-nogo-strong border-nogo/40 bg-nogo/10", dot: "bg-nogo" },
};
