    ...
    <AppShell>
      <header className="rule-b pb-6 mb-6">
        ...
        <p className="mt-3 text-ink-soft max-w-2xl">
          Each dot is a candidate property, color-coded by headline verdict. Submarket markers carry
          their median price and net yield. Click any dot for the deal memo.
        </p>
      </header>
      <PropertyMap />
    </AppShell>
